...
model_path = hf_hub_download(repo_id="Dhruva23101995/customer_purchase_prediction", filename="best_customer_purchase_model_v1.joblib")
model = joblib.load(model_path)

# Streamlit UI for Machine Failure Prediction
st.title("Customer Purchase Prediction App")
st.write("""
This application predicts the likelihood of a customer purchase based on its operational parameters.
